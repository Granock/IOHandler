...
using WindowSwitcher.Switcher.Internal;
...
public class Switcher(
    ...
    IUser32WindowWrapper user32WindowWrapper,
    ...
    private void SwitchWindowCore(SwitchType switchType) {
        ...
        if (!user32WindowWrapper.FocusWindow(window.Wrapper)) {
    ...
    private void InitializeCore() {
        ...
        _lastWindowIndex = -1;
        List<WindowWrapper> allWindows = user32WindowWrapper.GetAllCurrentWindows();
        WindowSwitcherConfiguration config = configurationService.GetConfiguration();
